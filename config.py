...
# DIQQAT: hozirgi kodda BYBIT/BINANCE API_KEY/SECRET hech qayerda
# ishlatilmaydi - barcha signal modullari Bybit'ning OCHIQ (public)
# market endpointlaridan foydalanadi, autentifikatsiya shart emas.
# Bu o'zgaruvchilar kelajakda kerak bo'lishi mumkin (masalan real
# hisobga ulanish uchun), hozircha bekorga sozlashning hojati yo'q.
...
# DIQQAT: hozir ishlatilmaydi - whale_tracker.py Bybit'ning o'z
# recent-trade endpointidan (bepul, kalitsiz) foydalanadi.
WHALE_ALERT_API_KEY = os.environ.get("WHALE_ALERT_API_KEY", "")
ETHERSCAN_API_KEY = os.environ.get("ETHERSCAN_API_KEY", "")

# --- Sentiment ---
# DIQQAT: hozir ishlatilmaydi - sentiment.py endi coin-spetsifik
# funding rate'ga asoslangan (LunarCrush o'rniga, qarang signals/sentiment.py).
